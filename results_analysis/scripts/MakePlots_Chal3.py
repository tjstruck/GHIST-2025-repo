...
for uid in res_dd['growth']:
    axB.axhline(res_dd['growth'][uid]['RRMSE'], color='black', alpha=0.5)
    axC.scatter(res_dd['growth'][uid]['generations'], res_dd['growth'][uid]['post_growth_scaling'], color='black', alpha=0.5)
